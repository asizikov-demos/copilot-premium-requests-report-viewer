...
2025-06-03,test-user-a,gpt-4.1-2025-04-14,invalid_number,false,Unlimited`,
  
  invalidDate: `date,username,model,quantity,exceeds_quota,total_monthly_quota
invalid-date,test-user-a,gpt-4.1-2025-04-14,1.00,false,Unlimited`,
...
2025-06-03,test-user-a,gpt-4.1-2025-04-14,1.00,false,Unlimited,extra_value`,

  invalidBooleanValues: `date,username,model,quantity,exceeds_quota,total_monthly_quota
2025-06-03,test-user-a,gpt-4.1-2025-04-14,1.00,maybe,Unlimited`
};
